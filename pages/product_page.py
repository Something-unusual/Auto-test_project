...
class ProductPage(BasePage):
    ...
    def product_name_in_basket_should_be_exact_product_name(self):
        ...
        assert product_name == product_in_add_message, "Product name in the basket is not the exact product added"
    ...
    def basket_total_should_be_exact_product_price(self):
        ...
        assert product_price == cart_total, "Basket total is not the exact product price"

    def should_be_product_price(self):
        assert self.is_element_present(*ProductPageLocators.PRODUCT_PRICE), "Product price is not presented"

    def should_be_basket_total_message(self):
        assert self.is_element_present(*ProductPageLocators.CART_TOTAL), "Basket total is not presented"
